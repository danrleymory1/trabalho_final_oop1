...
banco_dados.inserir_produto(produto1)
banco_dados.inserir_produto(produto2)
banco_dados.inserir_produto(produto3)
banco_dados.inserir_produto(produto4)
banco_dados.inserir_produto(produto5)
banco_dados.inserir_produto(produto6)
